...
import { validateMovement } from '../middleware/validation/categoryValidation.js';
...
router.post('/movement', authenticateToken, createMovementController);
...
router.put('/movements/update/:id', authenticateToken, updateMovementController);
