...
const DashBoard: React.FC = () => {
  ...
  return (
    <div className="p-8 bg-white shadow-md rounded-lg">
      ...
      <div className="mb-4">
        <label className="block text-sm font-semibold mb-2 text-primary" htmlFor="nombre">
          Nombre de la Empresa
        </label>
        <input
          id="nombre"
          type="text"
          className="input input-bordered input-ghost border-primary w-full sm:w-96 md:w-[500px] lg:w-[600px] max-w-full px-4 py-2 bg-background"
          placeholder="Ingrese el nombre de la empresa"
        />
      </div>
      <div className="mb-4">
        <label className="block text-sm font-semibold mb-2 text-primary" htmlFor="rubro">
          Rubro de la Empresa
        </label>
        <input
          id="rubro"
      ...
      <div className="mb-6">
        ...
        <div className="mb-4">
          <label className="flex items-center mb-2">
            <input type="radio" name="fieldType" className="radio mr-2 border-primary" />
            <span className="text-sm">
              Automático (Código, Nombre del Producto, Categoría, Caducidad, Precio Inicial,
              Precio Venta, Cantidad, Estado)
            </span>
          </label>
