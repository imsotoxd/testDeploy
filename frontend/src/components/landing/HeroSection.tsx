...
function HeroSection() {
  return (
    <section id='hero' className='flex flex-col md:flex-row justify-between items-center'>
      <img src={heroImg.src} alt="Imagen encabezado"
      ...
      <div className='flex flex-col items-center justify-center w-full md:w-1/2'>
        ...
        <div className='flex flex-col items-center justify-center w-full md:w-4/5 lg:w-1/2 p-4 md:p-0'>
          ...
          <p className='text-center text-textPrimary'>Aumente sus ventas y realice un seguimiento de cada unidad con nuestro software de gestión de stock y control de inventario.</p>
        </div>
      </div>
    </section>
  );
