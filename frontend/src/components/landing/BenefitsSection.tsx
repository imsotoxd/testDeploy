      ...
      <div className='flex flex-col items-start justify-center w-full md:w-1/2  p-12 sm:pb-32 gap-10' >
        <h3 className='text-3xl text-primary font-bold text-center m-4'>Beneficios de la gestión de stock y precios de Stockify </h3>
          ...
          <li className='flex items-start mb-2'>
            <img src={checkListPng.src} alt="Imagen Beneficios" className="object-cover w-[20px] h-[20px] mr-2" />
            <span>Agregar productos fácilmente: Permite añadir nuevos productos a tu inventario con rapidez, asegurando datos actualizados.</span>
          </li>
          <li className='flex items-start mb-2'>
            <img src={checkListPng.src} alt="Imagen Beneficios" className="object-cover w-[20px] h-[20px] mr-2" />
            <span>Registro de salida de productos: Mantiene un control detallado de los movimientos del inventario, reduciendo errores y pérdidas.</span>
          </li>
          <li className='flex items-start mb-2'>
            <img src={checkListPng.src} alt="Imagen Beneficios" className="object-cover w-[20px] h-[20px] mr-2" />
            <span>Localiza cualquier producto en tu inventario mediante un sistema de búsqueda optimizado.</span>
          </li>
          <li className='flex items-start mb-2'>
            <img src={checkListPng.src} alt="Imagen Beneficios" className="object-cover w-[20px] h-[20px] mr-2" />
            <span>Ahorra tiempo al evitar la búsqueda manual en listados extensos.</span>
          </li>
          <li className='flex items-start mb-2'>
            <img src={checkListPng.src} alt="Imagen Beneficios" className="object-cover w-[20px] h-[20px] mr-2" />
            <span>Permite prever necesidades de reposición y gestionar existencias adecuadamente.</span>
          </li>
          <li className='flex items-start mb-2'>
            <img src={checkListPng.src} alt="Imagen Beneficios" className="object-cover w-[20px] h-[20px] mr-2" />
            <span>Evita sobrestock y desabastecimiento, optimizando costos y espacio de almacenamiento.</span>
          </li>
        </ul>
      </div>
